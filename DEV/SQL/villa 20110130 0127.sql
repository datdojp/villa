...
INSERT INTO `mst_price_type` (`id`,`name_en`,`name_vi`) VALUES 
 (0,'Free',''),
 (1,'King',''),
 (2,'Occean','');
...
CREATE TABLE `transaction_prediction` (
  ...
  KEY `FK_transaction_prediction_2` (`price_type_id`),
  CONSTRAINT `FK_transaction_prediction_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_transaction_prediction_2` FOREIGN KEY (`price_type_id`) REFERENCES `mst_price_type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

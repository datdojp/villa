...
--
-- Definition of table `linc_season_tournament_team`
--

DROP TABLE IF EXISTS `linc_season_tournament_team`;
CREATE TABLE `linc_season_tournament_team` (
  `season_id` int(10) unsigned NOT NULL,
  `tournament_id` int(10) unsigned NOT NULL,
  `team_id` int(10) unsigned NOT NULL,
  PRIMARY KEY  USING BTREE (`season_id`,`tournament_id`,`team_id`),
  KEY `FK_linc_season_tournament_2` (`tournament_id`),
  KEY `FK_linc_season_tournament_team_3` (`team_id`),
  CONSTRAINT `FK_linc_season_tournament_team_1` FOREIGN KEY (`season_id`) REFERENCES `season` (`id`),
  CONSTRAINT `FK_linc_season_tournament_team_2` FOREIGN KEY (`tournament_id`) REFERENCES `tournament` (`id`),
  CONSTRAINT `FK_linc_season_tournament_team_3` FOREIGN KEY (`team_id`) REFERENCES `team` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `linc_season_tournament_team`
--

/*!40000 ALTER TABLE `linc_season_tournament_team` DISABLE KEYS */;
/*!40000 ALTER TABLE `linc_season_tournament_team` ENABLE KEYS */;
...
CREATE TABLE `mst_prediction_type` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `name_en` varchar(45) character set latin1 NOT NULL,
  `name_vi` varchar(45) character set latin1 NOT NULL,
  PRIMARY KEY  (`id`)
...
INSERT INTO `mst_price_type` (`id`,`name_en`,`name_vi`,`price`) VALUES 
 (0,'Free','Free',0),
 (1,'King','King',0),
 (2,'Occean','Occean',0);
...
CREATE TABLE `policy` (
  ...
  `version` int(10) unsigned NOT NULL default '0',
  `anonymous_statistics_predictions` int(10) unsigned NOT NULL,
  `anonymous_statistics_rate` double NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `prediction` (
  ...
  `price_type_id` int(10) unsigned NOT NULL,
  `win_team_id` int(10) unsigned NOT NULL,
  ...
  KEY `FK_prediction_4` (`win_team_id`),
  ...
  CONSTRAINT `FK_prediction_4` FOREIGN KEY (`win_team_id`) REFERENCES `team` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `season` (`id`,`begin_year`,`end_year`,`version`,`is_deleted`) VALUES 
 (1,2011,2012,0,0),
 (2,2012,2013,0,0);
...
CREATE TABLE `team` (
  ...
  `logo_file_name` varchar(1000) NOT NULL,
...
CREATE TABLE `transaction_package` (
  ...
  CONSTRAINT `FK_transaction_package_2` FOREIGN KEY (`id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
